Contributing to REBEL Coin
============================

The REBEL Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/rebelcoin-project/rebelcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the REBEL Coin project, and is not to be
confused with overall REBELCoin Network Protocol consensus changes.

Whether a pull request is merged into REBEL Coin rests with the project merge
...
Patches that change REBELCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the REBELCoin consensus, it must have been
...
The project leader is the release manager for each REBEL Coin release.
