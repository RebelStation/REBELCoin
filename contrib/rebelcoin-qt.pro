...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/rebelcoin-cli.cpp \
           src/rebelcoin-tx.cpp \
           src/rebelcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/rebelcoin.qrc src/qt/rebelcoin_locale.qrc

TRANSLATIONS += src/qt/locale/rebelcoin_bg.ts \
                src/qt/locale/rebelcoin_de.ts \
                src/qt/locale/rebelcoin_en.ts \
                src/qt/locale/rebelcoin_es.ts \
                src/qt/locale/rebelcoin_fi.ts \
                src/qt/locale/rebelcoin_fr.ts \
                src/qt/locale/rebelcoin_it.ts \
                src/qt/locale/rebelcoin_ja.ts \
                src/qt/locale/rebelcoin_pl.ts \
                src/qt/locale/rebelcoin_pt.ts \
                src/qt/locale/rebelcoin_ru.ts \
                src/qt/locale/rebelcoin_sk.ts \
                src/qt/locale/rebelcoin_sv.ts \
                src/qt/locale/rebelcoin_vi.ts \
                src/qt/locale/rebelcoin_zh_CN.ts \
                src/qt/locale/rebelcoin_zh_TW.ts
