...
def main():
    ...
    # Filter out hosts with multiple rebelcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple rebelcoin ports' % (ip_stats(ips)), file=sys.stderr)
