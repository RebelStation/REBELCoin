...
REBEL Coin is now available at `./src/rebelcoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/REBELCoin"

    touch "/Users/${USER}/Library/Application Support/REBELCoin/rebelcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/REBELCoin/rebelcoin.conf"

The first time you run rebelcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/REBELCoin/debug.log

Other commands:
-------

    ./src/rebelcoind -daemon # Starts the rebelcoin daemon.
    ./src/rebelcoin-cli --help # Outputs a list of command-line options.
    ./src/rebelcoin-cli help # Outputs a list of RPC commands when the daemon is running.
