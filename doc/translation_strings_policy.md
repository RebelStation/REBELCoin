...
This document provides guidelines for internationalization of the REBEL Coin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rebelcoin_en.ts` remains unchanged.
