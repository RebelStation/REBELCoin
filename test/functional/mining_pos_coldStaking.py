...
from test_framework.rebelcoin_node import rebelcoinTestNode
...
class REBELCoin_ColdStakingTest(rebelcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(rebelcoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 RBL from the pot)
...
if __name__ == '__main__':
    REBELCoin_ColdStakingTest().main()
