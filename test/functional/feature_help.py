...
"""Verify that starting rebelcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import rebelcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(rebelcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rebelcoin with -? for help text")
        ...
        self.log.info("Start rebelcoin with -version for version information")
