...
class ListReceivedTest (rebelcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 RBL.
        ...
        # Send 1 RBL to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 RBL sending them all (fee is 0.1 RBL)
        ...
        # Confirm transaction (2 RBL from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 RBL, send 0.6 RBL + 0.05 RBL fee
