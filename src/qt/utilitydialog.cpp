                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("REBEL Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About REBEL Coin"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #76767C;text-decoration:none'  href=\"\\1\">\\1</a>");
        ...
        QString header = tr("Usage:") + "\n" +
                         "  rebel coin-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("REBEL Coin is shutting down...") + "<br /><br />" +
