...
#include "qt/rebelcoin/settings/settingsbackupwallet.h"
#include "qt/rebelcoin/settings/settingsexportcsv.h"
#include "qt/rebelcoin/settings/settingsbittoolwidget.h"
#include "qt/rebelcoin/settings/settingssignmessagewidgets.h"
#include "qt/rebelcoin/settings/settingswalletrepairwidget.h"
#include "qt/rebelcoin/settings/settingswalletoptionswidget.h"
#include "qt/rebelcoin/settings/settingsmainoptionswidget.h"
#include "qt/rebelcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/rebelcoin/settings/settingsmultisendwidget.h"
#include "qt/rebelcoin/settings/settingsinformationwidget.h"
#include "qt/rebelcoin/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(REBELCoinGUI* parent);
    ~SettingsWidget();
