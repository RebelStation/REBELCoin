...
#include "qt/rebelcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/rebelcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(REBELCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to REBELCoinGUI::handleRestart()
