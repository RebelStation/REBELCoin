...
#include "qt/rebelcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/rebelcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(REBELCoinGUI* _window, QWidget *parent) :
