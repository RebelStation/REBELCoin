...
#include "qt/rebelcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/rebelcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(REBELCoinGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the REBEL Coin RPC console.") + "<br>" + tr("Use up and down arrows to navigate history, and %1 to clear screen.").arg("<b>" + clsKey + "</b>") + "<br>" + tr("Type <b>help</b> for an overview of available commands.") + "<br><span class=\"secwarning\"><br>" + tr("WARNING: Scammers have been active, telling users to type commands here, stealing their wallet contents. Do not use this console without fully understanding the ramifications of a command.") + "</span>"),
        true);
}
...
static bool PotentiallyDangerousCommand(const QString& cmd)
{
    ...
    if (cmd.size() >= 13 && cmd.leftRef(11) == "dumpprivkey") {
        // valid REBELCoin Transparent Address
        std::vector<std::string> args;
    ...
    if (cmd.size() >= 18 && cmd.leftRef(16) == "exportsaplingkey") {
        // valid REBELCoin Shield Address
        std::vector<std::string> args;
        parseCommandLineSettings(args, cmd.toStdString());
