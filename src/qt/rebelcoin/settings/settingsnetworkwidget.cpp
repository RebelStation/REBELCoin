...
#include "qt/rebelcoin/settings/settingsnetworkwidget.h"
#include "qt/rebelcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/rebelcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(REBELCoinGUI* _window, QWidget *parent) :
