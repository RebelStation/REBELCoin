...
#include "qt/rebelcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(REBELCoinGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("REBELCoin_tx_csv_export(*.csv)") : tr("REBELCoin_addresses_csv_export(*.csv)"),
        nullptr);
