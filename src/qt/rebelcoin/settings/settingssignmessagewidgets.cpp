...
#include "qt/rebelcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(REBELCoinGUI* _window, QWidget *parent) :
