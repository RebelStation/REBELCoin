...
#include "qt/rebelcoin/forms/ui_votedialog.h"

#include "qt/rebelcoin/mnmodel.h"
#include "qt/rebelcoin/mnselectiondialog.h"
...
{
    proposal = MakeUnique<ProposalInfo>(prop);
...
{
    REBELCoinGUI* window = dynamic_cast<REBELCoinGUI*>(parent());
