...
#include "qt/rebelcoin/topbar.h"
#include "qt/rebelcoin/forms/ui_topbar.h"
#include "qt/rebelcoin/lockunlock.h"
#include "qt/rebelcoin/qtutils.h"
#include "qt/rebelcoin/receivedialog.h"
#include "qt/rebelcoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/rebelcoin/balancebubble.h"
...
TopBar::TopBar(REBELCoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopRbl, ui->labelAmountTopShieldedEsir}, "amount-small-topbar");
    setCssProperty({ui->labelAmountRbl}, "amount-topbar");
    setCssProperty({ui->labelPendingRbl, ui->labelImmatureRbl}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("REBELCoin")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // RBL Total
    QString totalRbl = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // RBL
    // Top
    ui->labelAmountTopRbl->setText(totalTransparent);
    ui->labelAmountTopShieldedEsir->setText(totalShielded);
    // Expanded
    ui->labelAmountRbl->setText(totalRbl);
    ui->labelPendingRbl->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureRbl->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
