...
#include "qt/rebelcoin/sendcustomfeedialog.h"
#include "qt/rebelcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(REBELCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &REBELCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
