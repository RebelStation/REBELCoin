...
#include "qt/rebelcoin/furabstractlistitemdelegate.h"
#include "qt/rebelcoin/txviewholder.h"
#include "qt/rebelcoin/tooltipmenu.h"
#include "qt/rebelcoin/sendmultirow.h"
#include "qt/rebelcoin/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(REBELCoinGUI* parent);
    ~ColdStakingWidget();
