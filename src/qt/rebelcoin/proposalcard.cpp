...
#include "qt/rebelcoin/forms/ui_proposalcard.h"

#include "qt/rebelcoin/qtutils.h"

ProposalCard::ProposalCard(QWidget* parent) : QWidget(parent),
...
void ProposalCard::setProposal(const ProposalInfo& _proposalInfo)
{
    ...
    ui->labelPropMonths->setText(tr("%1 months passed of %2")
                                     .arg(proposalInfo.totalPayments - proposalInfo.remainingPayments)
