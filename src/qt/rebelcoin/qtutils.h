...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, REBELCoinGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, REBELCoinGUI* gui, double posX = 3);
