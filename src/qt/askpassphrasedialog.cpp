...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            REBELCoinGUI* window = static_cast<REBELCoinGUI*>(parentWidget());
...
{
    REBELCoinGUI* gui = static_cast<REBELCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<REBELCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("REBEL Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your RBLs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
