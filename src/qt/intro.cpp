...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || gArgs.GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("REBEL Coin"),
     ...
     * override -datadir in the rebelcoin.conf file in the default data directory
     * (to be consistent with rebelcoind behavior)
     */
