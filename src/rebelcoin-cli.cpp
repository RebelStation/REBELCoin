...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version")) {
        std::string strUsage = _("REBEL Coin RPC client version") + " " + FormatFullVersion() + "\n";
        if (!gArgs.IsArgSet("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  rebelcoin-cli [options] <command> [params]  " + _("Send command to REBEL Coin") + "\n" +
                        "  rebelcoin-cli [options] help                " + _("List commands") + "\n" +
                        "  rebelcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
