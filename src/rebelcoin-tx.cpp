...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("rebel coin rebelcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rebelcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rebelcoin transaction") + "\n" +
                               "  rebelcoin-tx [options] -create [commands]   " + _("Create hex-encoded rebelcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rebelcoin transaction
