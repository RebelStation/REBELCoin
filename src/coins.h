...
public:
    ...
    /**
     * Amount of rebelcoin coming in to a transaction
...
// REBELCoin: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
