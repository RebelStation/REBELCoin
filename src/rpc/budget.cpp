...
UniValue preparebudget(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 6)
        throw std::runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"rebelcoin-address\" monthy-payment\n"
            ...
            "5. \"rebelcoin-address\":   (string, required) REBELCoin address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.rebelstation.org /t/test-proposal\" 2 820800 \"D9oc6C3dttUbv8zd7zGNq1qKBGf4ZQ1XEE\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.rebelstation.org /t/test-proposal\" 2 820800 \"D9oc6C3dttUbv8zd7zGNq1qKBGf4ZQ1XEE\" 500"));
    ...
    if (!pwalletMain->CreateBudgetFeeTX(wtx, nHash, keyChange, false)) { // 50 RBL collateral for proposal
...
UniValue submitbudget(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 7)
        throw std::runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"rebelcoin-address\" monthly-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.rebelstation.org /t/test-proposal\" 2 820800 \"D9oc6C3dttUbv8zd7zGNq1qKBGf4ZQ1XEE\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.rebelstation.org /t/test-proposal\" 2 820800 \"D9oc6C3dttUbv8zd7zGNq1qKBGf4ZQ1XEE\" 500"));
...
UniValue mnbudgetvote(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "many" || (isAlias = strCommand == "alias")) {
        ...
        return mnBudgetVoteInner(pwalletMain, false, hash, false, nVote, mnAlias);
    }
...
UniValue getbudgetprojection(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) REBELCoin address of payment\n"
            "    \"Ratio\": x.xxx,               (numeric) Ratio of yeas vs nays\n"
            "    \"Yeas\": n,                    (numeric) Number of yea votes\n"
            "    \"Nays\": n,                    (numeric) Number of nay votes\n"
            "    \"Abstains\": n,                (numeric) Number of abstains\n"
            "    \"TotalPayment\": xxx.xxx,      (numeric) Total payment amount in RBL\n"
            "    \"MonthlyPayment\": xxx.xxx,    (numeric) Monthly payment amount in RBL\n"
            ...
            "    \"Allotted\": xxx.xxx,           (numeric) Amount of RBL allotted in current period\n"
            "    \"TotalBudgetAllotted\": xxx.xxx (numeric) Total RBL allotted\n"
            "  }\n"
            "  ,...\n"
            "]\n"
...
UniValue mnfinalbudget(const JSONRPCRequest& request)
{
    ...
    /* if (strCommand == "vote-many" || strCommand == "vote") {
        ...
        bool fLegacyMN = true;
        return (strCommand == "vote-many" ? mnBudgetVoteInner(pwallet, fLegacyMN, hash, true, CBudgetVote::VOTE_YES, nullopt) : mnLocalBudgetVoteInner(fLegacyMN, hash, true, CBudgetVote::VOTE_YES));*/
