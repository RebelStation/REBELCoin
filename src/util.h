...
extern const char * const REBELCoin_CONF_FILENAME;
extern const char * const REBELCoin_PID_FILENAME;
extern const char * const REBELCoin_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("rebelcoin-%s", name);
