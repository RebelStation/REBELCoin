...
//
// The Masternode Class. It contains the input of the 1000 RBL, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 25000 RBL - checking if valid masternode)
