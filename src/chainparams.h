 ...
 * REBELCoin system. There are three: the main network on which people trade goods
...
public:
	...
	std::string TreasuryAddress() const { return strTreasuryAddr; }
